  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center">
        <div className="w-full md:w-[90%] lg:w-[80%] xl:w-[70%] h-[800px] bg-warning text-black  rounded-xl p-6 sm:p-12 flex flex-col justify-center items-center my-36 relative">
